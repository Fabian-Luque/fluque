...
class Reserva extends Model
{
	...
	protected $fillable = ['monto_alojamiento','monto_consumo','monto_total','monto_sugerido','metodo_pago_id','monto_por_pagar', 'ocupacion','tipo_fuente_id',' habitacion_id ' ,'cliente_id','checkin', 'checkout','estado_reserva_id'];
